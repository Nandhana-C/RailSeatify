    ...
    return (
        <div className={`absolute top-0 left-0 h-screen w-screen bg-white transform ${open ? "-translate-x-0" : "-translate-x-full"} transition-transform duration-300 ease-in-out filter drop-shadow-md `}>
            ...
            <div className="flex flex-col ml-4">
                ...
                <button type="button" className="text-white w-full bg-[#007fff] hover:bg-[#0067cf]  focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-lg text-md px-4 py-2 text-center mr-3 md:mr-0">Logout</button>
        ...
        <nav className="flex filter drop-shadow-md bg-white px-4 py-4 h-20 items-center">
            ...
            <div className="w-9/12 flex justify-end items-center">
                ...
                <div className="hidden md:flex">
                   ...
                   {/* <button type="button" className="text-white w-full bg-[#007fff] hover:bg-[#0067cf]  focus:ring-4 focus:outline-none focus:ring-blue-300 font-semibold rounded-lg text-md px-4 py-2 text-center mr-3 md:mr-0">Logout</button> */}
                   <h1 className='font-bold mx-2' onClick={onSignout}>LOGOUT</h1>
                </div>
